...
import AgentOSModelSelector from './AgentOSModelSelector';
...
function ModelSelectorContent({
  ...
  reasoning?: NonNullable<TInterfaceConfig['agentosReasoning']>;
}) {
  ...
  // Keep all hooks above the endpoint-specific render branches. Model selector
  // state can change between renders when an Agent or model spec is selected.
  if (endpoint === 'agents') {
    return null;
  }

  if (reasoning?.enabled === true) {
    return <AgentOSModelSelector reasoning={reasoning} />;
  }
...
export default function ModelSelector({ startupConfig }: ModelSelectorProps) {
  ...
  const agentosReasoning = interfaceConfig.agentosReasoning;
  ...
  return (
    <ModelSelectorChatProvider>
      <ModelSelectorProvider startupConfig={startupConfig}>
        <ModelSelectorContent reasoning={agentosReasoning} />
