...
export const agentosReasoningLevelSchema = z.enum(['low', 'medium', 'high']);

const agentosReasoningModelSchema = z.object({
  /** Only levels proven by the relay probe are exposed for this model. */
  levels: z.array(agentosReasoningLevelSchema).default([]),
});

export const agentosReasoningSchema = z.object({
  enabled: z.boolean().default(false),
  default: agentosReasoningLevelSchema.default('medium'),
  levels: z.array(agentosReasoningLevelSchema).default(['low', 'medium', 'high']),
  models: z.record(agentosReasoningModelSchema).default({}),
});

export type TAgentOSReasoningConfig = z.infer<typeof agentosReasoningSchema>;
...
export const interfaceSchema = z
  .object({
    ...
    agentosReasoning: agentosReasoningSchema.optional(),
...
export enum LocalStorageKeys {
  ...
  /** Last checked toggle for the native image generation toolkit per conversation ID */
